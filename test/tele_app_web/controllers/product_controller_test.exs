defmodule TeleAppWeb.ProductControllerTest do
  use TeleAppWeb.ConnCase

  import TeleApp.CatalogFixtures

  @create_attrs %{article: "some article", description: "some description", name: "some name", name_short: "some name_short", price: "120.5", qty: 42, visible: true}
