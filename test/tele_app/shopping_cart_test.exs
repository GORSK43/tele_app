defmodule TeleApp.ShoppingCartTest do
  use TeleApp.DataCase

  alias TeleApp.ShoppingCart

  describe "carts" do
    alias TeleApp.ShoppingCart.Cart

    import TeleApp.ShoppingCartFixtures
  ...
  describe "cart_items" do
    ...
    test "create_cart_item/1 with valid data creates a cart_item" do
      ...
      assert cart_item.price == Decimal.new("120.5")
    ...
    test "update_cart_item/2 with valid data updates the cart_item" do
      ...
      assert cart_item.price == Decimal.new("456.7")
