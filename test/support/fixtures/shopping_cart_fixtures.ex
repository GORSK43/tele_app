defmodule TeleApp.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `TeleApp.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> TeleApp.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> TeleApp.ShoppingCart.create_cart_item()
